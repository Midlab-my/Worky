  ...
  candidato: [
    {
      ...
      price: "R$ 0",
      period: "/mês",
      description: "Para profissionais iniciando a exploração de dados do mercado.",
    ...
    },
    {
      ...
      price: "R$ 9",
      period: "/mês",
      description: "Para quem leva a busca por vaga a sério e quer o mercado inteiro na mão.",
      features: ["Buscas ilimitadas", "Simulador de Match com IA", "Alertas em tempo real"],
      cta: "Assinar Pro",
      featured: true,
      badge: "Recomendado",
    },
  ...
  empresa: [
    {
      ...
      price: "R$ 0",
      period: "/mês",
      description: "Cadastre vagas gratuitamente e comece a atrair candidatos.",
    ...
    },
    {
      ...
      price: "R$ 199",
      period: "/mês",
      description: "O padrão da indústria para recrutadores e analistas sérios.",
      features: ["Lista de candidatos compatíveis desbloqueada", "Simulador de Match com IA", "Alertas em tempo real"],
      cta: "Assinar Pro",
      featured: true,
      badge: "Recomendado",
    },
