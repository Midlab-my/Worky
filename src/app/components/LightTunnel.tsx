...
void mainImage(out vec4 o, in vec2 fragCoord) {
  ...
  float swing = iTime * (uSpeed * 0.12 + 0.025) * rotationOsc;
  ...
  float tipFade = smoothstep(uFadeFar, max(uFadeNear + 0.15, uFadeFar * 0.35), r);
  float distFade = smoothstep(0.0, uFadeNear, r) * tipFade;
