        ...
        <div className="bg-white border-4 border-neutral-900 p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <button
                type="submit"
                className="flex-1 bg-neutral-900 text-white py-3 border-2 border-neutral-900 hover:bg-neutral-700 font-mono w-full sm:w-auto"
              >
                [BUSCAR VAGAS]
              </button>
              <button
                ...
                className="px-8 py-3 border-2 border-neutral-400 hover:bg-neutral-200 font-mono w-full sm:w-auto"
              >
                [LIMPAR]
              </button>
            </div>
